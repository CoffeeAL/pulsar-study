...
4. Subscribe consumer to topic
    docker exec -it pulsar /pulsar/bin/pulsar-client consume persistent://my-tenant/my-namespace/my-topic --num-messages 0 --subscription-name my-subscription --subscription-type Exclusive
